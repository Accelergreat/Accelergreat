...
public class WeatherForecastGetTests3 : AccelergreatXunitTest
{
    public WeatherForecastGetTests3(IAccelergreatEnvironmentPool environmentPool) : base(environmentPool)
    {
    }
