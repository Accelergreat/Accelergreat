...
public class SqlServerDatabaseTests4 : AccelergreatXunitTest
{
    public SqlServerDatabaseTests4(IAccelergreatEnvironmentPool environmentPool) : base(environmentPool)
    {
    }
