...
public class SqlServerDatabaseTests6 : AccelergreatXunitTest
{
    public SqlServerDatabaseTests6(IAccelergreatEnvironmentPool environmentPool) : base(environmentPool)
    {
    }
