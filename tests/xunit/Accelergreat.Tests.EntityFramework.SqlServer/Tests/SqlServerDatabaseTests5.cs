...
public class SqlServerDatabaseTests5 : AccelergreatXunitTest
{
    public SqlServerDatabaseTests5(IAccelergreatEnvironmentPool environmentPool) : base(environmentPool)
    {
    }
