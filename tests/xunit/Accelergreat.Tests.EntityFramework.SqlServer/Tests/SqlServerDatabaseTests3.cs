...
public class SqlServerDatabaseTests3 : AccelergreatXunitTest
{
    public SqlServerDatabaseTests3(IAccelergreatEnvironmentPool environmentPool) : base(environmentPool)
    {
    }
