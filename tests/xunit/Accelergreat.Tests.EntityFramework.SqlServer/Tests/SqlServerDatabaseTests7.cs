...
public class SqlServerDatabaseTests7 : AccelergreatXunitTest
{
    public SqlServerDatabaseTests7(IAccelergreatEnvironmentPool environmentPool) : base(environmentPool)
    {
    }
