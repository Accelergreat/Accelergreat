...
public class SqlServerDatabaseTests8 : AccelergreatXunitTest
{
    public SqlServerDatabaseTests8(IAccelergreatEnvironmentPool environmentPool) : base(environmentPool)
    {
    }
