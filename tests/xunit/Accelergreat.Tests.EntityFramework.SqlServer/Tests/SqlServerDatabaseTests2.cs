...
public class SqlServerDatabaseTests2 : AccelergreatXunitTest
{
    public SqlServerDatabaseTests2(IAccelergreatEnvironmentPool environmentPool) : base(environmentPool)
    {
    }
