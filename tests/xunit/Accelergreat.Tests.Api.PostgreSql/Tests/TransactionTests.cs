...
namespace Accelergreat.Tests.Api.PostgreSql.Tests;
...
public class TransactionTests : AccelergreatXunitTest
{
    ...
    public async Task Add_Standard()
    {
        ...
        var testPostgreSqlDatabaseComponent = GetComponent<TestPostgreSqlDatabaseComponent>();

        var dbContextFactory = testPostgreSqlDatabaseComponent.DbContextFactory;
    ...
    public async Task Add_Standard_Via_Proxied_Context()
    {
        ...
        var dbContextFactory = testPostgreSqlDatabaseComponent.DbContextFactory.ChangeContextType<AdventureWorks2016Context2>();
