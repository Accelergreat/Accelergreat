...
public class PostgreSqlDatabaseTests : AccelergreatXunitTest
{
    public PostgreSqlDatabaseTests(IAccelergreatEnvironmentPool environmentPool) : base(environmentPool)
    {
    }
