...
public class PostgreSqlDatabaseTests8 : AccelergreatXunitTest
{
    public PostgreSqlDatabaseTests8(IAccelergreatEnvironmentPool environmentPool) : base(environmentPool)
    {
    }
