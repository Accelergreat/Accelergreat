...
public class PostgreSqlDatabaseTests4 : AccelergreatXunitTest
{
    public PostgreSqlDatabaseTests4(IAccelergreatEnvironmentPool environmentPool) : base(environmentPool)
    {
    }
