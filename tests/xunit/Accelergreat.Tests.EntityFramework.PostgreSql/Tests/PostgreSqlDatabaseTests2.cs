...
public class PostgreSqlDatabaseTests2 : AccelergreatXunitTest
{
    public PostgreSqlDatabaseTests2(IAccelergreatEnvironmentPool environmentPool) : base(environmentPool)
    {
    }
