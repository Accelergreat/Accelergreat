...
public class PostgreSqlDatabaseTests7 : AccelergreatXunitTest
{
    public PostgreSqlDatabaseTests7(IAccelergreatEnvironmentPool environmentPool) : base(environmentPool)
    {
    }
