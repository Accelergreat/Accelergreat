...
public class PostgreSqlDatabaseTests6 : AccelergreatXunitTest
{
    public PostgreSqlDatabaseTests6(IAccelergreatEnvironmentPool environmentPool) : base(environmentPool)
    {
    }
