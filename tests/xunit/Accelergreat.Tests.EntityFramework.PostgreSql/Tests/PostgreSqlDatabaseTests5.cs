...
public class PostgreSqlDatabaseTests5 : AccelergreatXunitTest
{
    public PostgreSqlDatabaseTests5(IAccelergreatEnvironmentPool environmentPool) : base(environmentPool)
    {
    }
