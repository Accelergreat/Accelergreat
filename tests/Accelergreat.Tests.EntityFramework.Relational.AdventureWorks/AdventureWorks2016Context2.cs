...
namespace Accelergreat.Tests.EntityFramework.Relational.AdventureWorks
{
    public class AdventureWorks2016Context2 : DbContext
    {

        public AdventureWorks2016Context2(DbContextOptions<AdventureWorks2016Context2> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VPersonDemographic>(entity =>
            {
                ...
                entity.Property(e => e.DateFirstPurchase);
            ...
            modelBuilder.Entity<VProductModelInstruction>(entity =>
            {
                ...
                entity.Property(e => e.MachineHours);
                ...
                entity.Property(e => e.SetupHours);
